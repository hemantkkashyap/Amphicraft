...
export default function Contact() {
  return (
    <>
    <Navbar/>
     <section class="pt-20 w-full xl:py-24 lg:py-20 py-12 bg-slate-50 border-b border-gray-300">
        ...
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
          <div>
            ...
            <div class="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
              <div class="rounded-2xl border border-gray-200 bg-white p-7 transition-all duration-500 hover:bg-indigo-600">
                <Link class="w-14 h-14 bg-indigo-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
                ...
                <h5 class="text-gray-900 text-xl font-semibold leading-8 mb-3 transition-all duration-500 group-hover:text-white">Support</h5>
                <p class="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">We Provide Various Methods For You To Carry Out All Transactions Related To Your Finances</p>
              </div>
              <div class="rounded-2xl border border-gray-200 bg-white p-7 transition-all duration-500 hover:bg-indigo-600">
                <a href="javascript:;" class="w-14 h-14 bg-indigo-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
                ...
                <h5 class="text-gray-900 text-xl font-semibold leading-8 mb-3 transition-all duration-500 group-hover:text-white">Pagedone Blog</h5>
                <p class="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">We have the most up-to-date security to support the security of all our customers in carrying out all transactions. </p>
              </div>
            </div>
          ...
          <form action="" class="h-fit bg-white border border-slate-200 rounded-2xl lg:p-12 p-8 w-full max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
            <div class="relative mb-8">
              ...
              <div class="relative text-gray-500 focus-within:text-gray-900">
                ...
                <input type="text" id="default-search" class="w-full block h-12 pr-5 pl-12 py-2.5 text-lg leading-7 font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none" placeholder="Hemant"/>
              </div>
            </div>
            <div class="relative mb-8">
            ...
            <button class="w-full h-12 rounded-full bg-indigo-600 hover:bg-indigo-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">Send message <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
