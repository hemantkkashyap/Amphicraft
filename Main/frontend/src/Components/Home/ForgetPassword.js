...
const ForgetPassword = () => {
  ...
  const handleEmailSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://amphicraft.vercel.app/api/auth/sendemail", {
        method: "POST",
        headers: {
  ...
  const handleOtpSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://amphicraft.vercel.app/api/auth/verifyotp", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://amphicraft.vercel.app/api/auth/resetpassword",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
